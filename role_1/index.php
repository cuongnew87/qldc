...
<head>
    ...
    <link rel="stylesheet" href="<?php echo WEB_URL ?>plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css" />
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            $sql = "SELECT count(*) AS num_resident FROM residents WHERE aid = (SELECT aid FROM residents WHERE rsd_mail = '" . $user_email . "')";
            $result = $conn->query($sql);
            ...
            $sql = "SELECT count(*) AS num_complain FROM complains, buildings, apartments WHERE buildings.bldid = apartments.bldid AND complains.aid = apartments.aid AND branch_id = 1";
            $result = $conn->query($sql);
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="<?php echo WEB_URL ?>role_1/profile.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                ...
                                <? echo  $_SESSION['email'] ?>
                                <a href="<?php echo WEB_URL ?>pages/tables/tennants.php?branch_id=1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <?php
                                            $sql = "SELECT * FROM complains, buildings, apartments WHERE buildings.bldid = apartments.bldid AND complains.aid = apartments.aid AND branch_id = 1 LIMIT 10";
                                            $result = $conn->query($sql);
                                            ...
                                            ?>
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img" src="<?php echo WEB_URL ?>dist/img/tennants/user-default.png" alt="User Avatar" />

                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    <?php echo $row['a_name'] ?>
                                                                    <small class="contacts-list-date float-right"><?php echo $row['cpl_date'] ?></small>
                                                                </span>
